  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-8">
        ...
        <h2 className=' text-center text-2xl font-semibold mb-10' > Enter your <span className=' text-green-500'>soil details</span> and schedule your <span className=' text-green-500'>Soil Health Test</span> .</h2>
